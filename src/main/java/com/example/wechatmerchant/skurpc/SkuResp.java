...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.example.wechatmerchant.skurpc.SkuResp result) {
      if (dataBuilder_ == null) {
    ...
    private void buildPartial0(com.example.wechatmerchant.skurpc.SkuResp result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              com.example.wechatmerchant.skurpc.SkuInfo m =
                  input.readMessage(
                      com.example.wechatmerchant.skurpc.SkuInfo.parser(),
                      extensionRegistry);
              if (dataBuilder_ == null) {
                ensureDataIsMutable();
                data_.add(m);
